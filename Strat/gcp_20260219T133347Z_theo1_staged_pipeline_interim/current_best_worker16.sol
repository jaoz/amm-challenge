...
contract Strategy is AMMStrategyBase {
    ...
    uint256 constant TOX_BLEND_DECAY = 689216312407755412; // 0.78  [FIX 3] proper EMA (was 0.051)
    uint256 constant ACT_BLEND_DECAY = 985000000000000000; // 0.985
    uint256 constant PHAT_ALPHA = 234485590739856660; // 0.26
    uint256 constant PHAT_ALPHA_RETAIL = 57287615797989926; // 0.05
    ...
    // --- Adaptive Shock Gate ---
    uint256 constant GATE_SIGMA_MULT = 7453060246757229884;
    ...
    uint256 constant SHIELD_TRIGGER = 3543703079801748; // ~30 bps
    ...
    // --- fee model constants ---
    uint256 constant BASE_FEE = 473421549418206;
    uint256 constant SIGMA_COEF = 111992134144107017; // 0.111
    uint256 constant LAMBDA_COEF = 1303758308070657;
    uint256 constant FLOW_SIZE_COEF = 392417670986792780;
    ...
    uint256 constant DIR_TOX_COEF = 13589277383119918;
    uint256 constant STALE_DIR_COEF = 699568662855613841; // [FIX 7] in mutable list
    ...
    function getName() external pure override returns (string memory) {
        return "Theo1LocalBest_D11_TOX_BLEND_DECAY_DN7_PHAT_ALPHA_DN3_LAMBDA_COEF_DN3_A2982BB4";
    }
}

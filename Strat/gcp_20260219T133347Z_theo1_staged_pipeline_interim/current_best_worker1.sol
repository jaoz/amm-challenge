...
contract Strategy is AMMStrategyBase {
    ...
    uint256 constant TOX_BLEND_DECAY = 703251927495537389; // 0.78  [FIX 3] proper EMA (was 0.051)
    ...
    uint256 constant STALE_DIR_COEF = 699439034685934547; // [FIX 7] in mutable list
    ...
    function getName() external pure override returns (string memory) {
        return "Theo1LocalBest_D8_TOX_BLEND_DECAY_DN5_PHAT_ALPHA_DN3_LAMBDA_COEF_DN3_3EFC902B";
    }
}

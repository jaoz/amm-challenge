...
contract Strategy is AMMStrategyBase {
    uint256 private constant OPEN_BPS = 106;
    uint256 private constant PRIOR_BPS = 56;

    uint256 private constant MIN_BPS = 0;
    uint256 private constant MAX_BPS = 1000;
    uint256 private constant TARGET_MAX_BPS = 443;
    uint256 private constant MAX_JUMP_BPS = 15;
    uint256 private constant MAX_ASYM_BPS = 138;
    uint256 private constant MAX_SKEW_BPS = 54;

    uint256 private constant SHIELD_TRIGGER_BPS = 45;
    uint256 private constant SHIELD_BUFFER_BPS = 1;

    uint256 private constant RETAIL_MEAN_Y = 20 * WAD;

    uint256 private constant A_LAMBDA = 40e16;
    uint256 private constant A_LAMBDA_SAME = 40e16;
    uint256 private constant A_ARB = 55e16;
    uint256 private constant A_ARB_SAME = 55e16;
    uint256 private constant A_VOL = 11e16;
    uint256 private constant A_WEAK = 12e16;
    uint256 private constant A_MID = 18e16;
    uint256 private constant A_MID_SAME = 0e16;

    uint256 private constant EPS_WEAK_BPS = 368;
    uint256 private constant COLLAPSE_BUF_BPS = 33;
    uint256 private constant ANCHOR_W = 33e16;

    uint256 private constant ARB_ANCHOR_GATE_BPS = 119;
    uint256 private constant ARB_MOVE_FLOOR_BPS = 68;
    uint256 private constant SIZE_SMALL_ABS_Y = 9e17; // 1.2 Y
    uint256 private constant SIZE_SMALL_REL_WAD = 54e16; // 6%
    ...
    function getName() external pure override returns (string memory) {
        return "PowellDirectNoShare_best_worker_4";
    }

...
contract Strategy is AMMStrategyBase {
    uint256 private constant OPEN_BPS = 41;
    uint256 private constant PRIOR_BPS = 57;

    uint256 private constant MIN_BPS = 0;
    uint256 private constant MAX_BPS = 1000;
    uint256 private constant TARGET_MAX_BPS = 678;
    uint256 private constant MAX_JUMP_BPS = 19;
    uint256 private constant MAX_ASYM_BPS = 144;
    uint256 private constant MAX_SKEW_BPS = 144;

    uint256 private constant SHIELD_TRIGGER_BPS = 22;
    uint256 private constant SHIELD_BUFFER_BPS = 21;

    uint256 private constant RETAIL_MEAN_Y = 20 * WAD;

    uint256 private constant A_LAMBDA = 48e16;
    uint256 private constant A_LAMBDA_SAME = 82e16;
    uint256 private constant A_ARB = 28e16;
    uint256 private constant A_ARB_SAME = 36e16;
    uint256 private constant A_VOL = 13e16;
    uint256 private constant A_WEAK = 23e16;
    uint256 private constant A_MID = 33e16;
    uint256 private constant A_MID_SAME = 18e16;

    uint256 private constant EPS_WEAK_BPS = 132;
    uint256 private constant COLLAPSE_BUF_BPS = 18;
    uint256 private constant ANCHOR_W = 64e16;

    uint256 private constant ARB_ANCHOR_GATE_BPS = 26;
    uint256 private constant ARB_MOVE_FLOOR_BPS = 43;
    uint256 private constant SIZE_SMALL_ABS_Y = 53e17; // 1.2 Y
    uint256 private constant SIZE_SMALL_REL_WAD = 16e16; // 6%
    ...
    function getName() external pure override returns (string memory) {
        return "PowellDirectNoShare_best_worker_1";
    }

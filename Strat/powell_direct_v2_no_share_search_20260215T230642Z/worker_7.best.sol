...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant COLLAPSE_BUF_BPS = 42;
    uint256 private constant ANCHOR_W = 68e16;

    uint256 private constant ARB_ANCHOR_GATE_BPS = 240;
    uint256 private constant ARB_MOVE_FLOOR_BPS = 67;
    uint256 private constant SIZE_SMALL_ABS_Y = 9e17; // 1.2 Y
    uint256 private constant SIZE_SMALL_REL_WAD = 7e16; // 6%
    ...
    function getName() external pure override returns (string memory) {
        return "PowellDirectNoShare_best_worker_7";
    }

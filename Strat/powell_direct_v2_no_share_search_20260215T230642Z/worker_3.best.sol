...
contract Strategy is AMMStrategyBase {
    uint256 private constant OPEN_BPS = 22;
    uint256 private constant PRIOR_BPS = 62;

    uint256 private constant MIN_BPS = 0;
    uint256 private constant MAX_BPS = 1000;
    uint256 private constant TARGET_MAX_BPS = 97;
    uint256 private constant MAX_JUMP_BPS = 12;
    uint256 private constant MAX_ASYM_BPS = 105;
    uint256 private constant MAX_SKEW_BPS = 105;

    uint256 private constant SHIELD_TRIGGER_BPS = 118;
    uint256 private constant SHIELD_BUFFER_BPS = 1;

    uint256 private constant RETAIL_MEAN_Y = 20 * WAD;

    uint256 private constant A_LAMBDA = 19e16;
    uint256 private constant A_LAMBDA_SAME = 86e16;
    uint256 private constant A_ARB = 55e16;
    uint256 private constant A_ARB_SAME = 55e16;
    uint256 private constant A_VOL = 24e16;
    uint256 private constant A_WEAK = 45e16;
    uint256 private constant A_MID = 5e16;
    uint256 private constant A_MID_SAME = 5e16;

    uint256 private constant EPS_WEAK_BPS = 248;
    uint256 private constant COLLAPSE_BUF_BPS = 110;
    uint256 private constant ANCHOR_W = 40e16;

    uint256 private constant ARB_ANCHOR_GATE_BPS = 50;
    uint256 private constant ARB_MOVE_FLOOR_BPS = 68;
    uint256 private constant SIZE_SMALL_ABS_Y = 98e17; // 1.2 Y
    ...
    function getName() external pure override returns (string memory) {
        return "PowellDirectNoShare_best_worker_3";
    }

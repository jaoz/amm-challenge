...
contract Strategy is AMMStrategyBase {
    uint256 private constant OPEN_BPS = 116;
    uint256 private constant PRIOR_BPS = 58;

    uint256 private constant MIN_BPS = 0;
    uint256 private constant MAX_BPS = 1000;
    uint256 private constant TARGET_MAX_BPS = 755;
    uint256 private constant MAX_JUMP_BPS = 105;
    uint256 private constant MAX_ASYM_BPS = 131;
    uint256 private constant MAX_SKEW_BPS = 110;

    uint256 private constant SHIELD_TRIGGER_BPS = 23;
    ...
    uint256 private constant A_LAMBDA_SAME = 32e16;
    uint256 private constant A_ARB = 30e16;
    uint256 private constant A_ARB_SAME = 30e16;
    uint256 private constant A_VOL = 37e16;
    uint256 private constant A_WEAK = 13e16;
    uint256 private constant A_MID = 7e16;
    uint256 private constant A_MID_SAME = 7e16;

    uint256 private constant EPS_WEAK_BPS = 167;
    uint256 private constant COLLAPSE_BUF_BPS = 152;
    uint256 private constant ANCHOR_W = 66e16;

    uint256 private constant ARB_ANCHOR_GATE_BPS = 359;
    uint256 private constant ARB_MOVE_FLOOR_BPS = 42;
    uint256 private constant SIZE_SMALL_ABS_Y = 40e17; // 1.2 Y
    uint256 private constant SIZE_SMALL_REL_WAD = 17e16; // 6%
    ...
    function getName() external pure override returns (string memory) {
        return "PowellDirectNoShare_best_worker_6";
    }

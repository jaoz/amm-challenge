...
contract Strategy is AMMStrategyBase {
    ...
    function getName() external pure override returns (string memory) {
        return "WorldState_BandShift_tune_09";
    }
        ...
        returns (uint256 bidFee, uint256 askFee)
    {
        ...
        if (bidPrev == 0) bidPrev = bpsToWad(76);
        if (askPrev == 0) askPrev = bpsToWad(76);
        ...
        if (stepTrades == 1) {
            ...
            if (directionOk && relToHat <= bpsToWad(110)) {
                probableArb = true;
            }
        }
        ...
        bidBps = _clampBps(bidBps, 56, 104);
        askBps = _clampBps(askBps, 56, 104);
    ...
    function _baseFromState(
        ...
        uint256 base = tradeCount < 180 ? 77 : 80;

...
contract Strategy is AMMStrategyBase {
    uint256 private constant OPEN_BPS = 14;
    uint256 private constant PRIOR_BPS = 17;

    uint256 private constant MIN_BPS = 0;
    uint256 private constant MAX_BPS = 1000;
    uint256 private constant TARGET_MAX_BPS = 352;
    uint256 private constant MAX_JUMP_BPS = 9;
    uint256 private constant MAX_ASYM_BPS = 36;
    uint256 private constant MAX_SKEW_BPS = 25;

    uint256 private constant SHIELD_TRIGGER_BPS = 31;
    uint256 private constant SHIELD_BUFFER_BPS = 9;

    uint256 private constant RETAIL_MEAN_Y = 20 * WAD;

    uint256 private constant A_LAMBDA = 9e16;
    uint256 private constant A_LAMBDA_SAME = 41e16;
    uint256 private constant A_ARB = 8e16;
    uint256 private constant A_ARB_SAME = 12e16;
    uint256 private constant A_VOL = 16e16;
    uint256 private constant A_WEAK = 33e16;
    uint256 private constant A_MID = 6e16;
    uint256 private constant A_MID_SAME = 4e16;

    uint256 private constant EPS_WEAK_BPS = 54;
    uint256 private constant COLLAPSE_BUF_BPS = 32;
    uint256 private constant ANCHOR_W = 40e16;

    uint256 private constant ARB_ANCHOR_GATE_BPS = 430;
    uint256 private constant ARB_MOVE_FLOOR_BPS = 9;
    uint256 private constant SIZE_SMALL_ABS_Y = 27e17; // 1.2 Y
    uint256 private constant SIZE_SMALL_REL_WAD = 19e16; // 6%

...
PARAM_BOUNDS: dict[str, tuple[float, float]] = {
    ...
    "max_fee_bps": (40.0, 1_000.0),
    "max_step_change_bps": (1.0, 8.0),
    "max_asym_bps": (2.0, 24.0),
    "normalizer_state_alpha": (0.05, 0.95),
    "normalizer_pretrade_arb_alpha": (0.10, 1.0),
    "eps_weak": (0.01, 0.25),
    "w_arb_anchor": (0.20, 0.90),
    "c_sigma": (0.5, 5.0),
    "mid_smoothing": (0.01, 0.40),
    "mid_smoothing_same_step": (0.0, 0.08),
    "max_anchor_move_bps": (4.0, 36.0),
    "max_mid_move_bps": (2.0, 24.0),
    "alpha_lambda": (0.02, 0.30),
    "alpha_lambda_same_step": (0.06, 0.45),
    "alpha_arb": (0.02, 0.30),
    "alpha_arb_same_step": (0.06, 0.55),
    "alpha_vol": (0.02, 0.30),
    "alpha_share": (0.02, 0.30),
    "alpha_order": (0.02, 0.30),
    "alpha_kappa": (0.01, 0.20),
    "lambda_same_step_bonus": (0.2, 2.5),
    "lambda_prior": (0.4, 1.2),
    "order_size_prior": (8.0, 40.0),
    "kappa_prior": (1.0, 30.0),
    "arb_anchor_gate": (0.001, 0.03),
    "arb_move_floor": (0.00001, 0.005),
    "retail_size_sigma_assumed": (0.8, 1.8),
    "retail_mean_prior_y": (14.0, 28.0),
    "retail_mean_blend": (0.05, 0.95),
    "size_arb_abs_y": (0.2, 4.0),
    "size_arb_rel_ratio": (0.01, 0.30),
    "size_arb_relax_anchor_mult": (1.0, 3.0),
    "size_arb_relax_move_mult": (0.1, 1.0),
    "size_tail_prob_gate": (0.08, 0.60),
    "size_tail_relax_anchor_mult": (1.0, 4.0),
    "size_tail_relax_move_mult": (0.1, 1.0),
    "value_penalty_arb": (0.0, 40.0),
    "value_penalty_stale": (0.0, 120.0),
    "value_penalty_inv_abs": (0.0, 80.0),
    "value_penalty_inv_signed": (0.0, 50.0),
    "value_penalty_lambda_gap": (0.0, 60.0),
    "value_penalty_spread": (0.0, 80.0),
    "value_penalty_jump": (0.0, 80.0),
    "edge_arb_scale": (0.0, 80.0),
    "edge_inventory_scale": (0.0, 40.0),
    "arb_shield_trigger_bps": (20.0, 80.0),
    "arb_shield_buffer_bps": (20.0, 60.0),
}

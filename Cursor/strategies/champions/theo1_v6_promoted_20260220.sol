...
contract Strategy is AMMStrategyBase {
    ...
    uint256 constant DIR_DECAY = 697538599778672916; // 0.80
    ...
    uint256 constant SIZE_BLEND_DECAY = 975830804599924866; // 0.818
    uint256 constant SIZE_SMALL_DECAY = 982960992367827223; // 0.98  [FIX 2] sub-threshold blend
    uint256 constant TOX_BLEND_DECAY = 295746770355970796; // 0.78  [FIX 3] proper EMA (was 0.051)
    uint256 constant ACT_BLEND_DECAY = 985000000000000000; // 0.985
    uint256 constant PHAT_ALPHA = 209752689373923265; // 0.26
    uint256 constant PHAT_ALPHA_RETAIL = 51005450930144033; // 0.05
    uint256 constant DIR_IMPACT_MULT = 2;

    // --- [FIX 6] Gap-aware pHat update ---
    uint256 constant GAP_PHAT_ALPHA_BOOST = 25372659435804200; // 0.03 per elapsed step beyond 1
    ...
    uint256 constant SHIELD_TRIGGER = 4052323186534301; // ~30 bps
    uint256 constant SHIELD_BUFFER = 255823447890247; // 10 bps
    ...
    // --- fee model constants ---
    uint256 constant BASE_FEE = 568587652204455;
    ...
    uint256 constant SIGMA_TOX_COEF = 37584298937674520;
    uint256 constant TAIL_KNEE = 15200000000000000;
    uint256 constant TAIL_SLOPE_PROTECT = 883435866216913286; // 0.93
    ...
    function getName() external pure override returns (string memory) {
        return "Theov3LocalBest_D22_SHIELD_TRIGGER_UP21_TOX_BLEND_DECAY_DN18_SHIELD_BUFFER_DN16_7D57D2E3";
    }
}

...
contract Strategy is AMMStrategyBase {
    ...
    uint256 constant DIR_DECAY = 782451454198703892; // 0.80
    ...
    uint256 constant SIZE_BLEND_DECAY = 892458972007704194; // 0.818
    uint256 constant SIZE_SMALL_DECAY = 983855995259103739; // 0.98  [FIX 2] sub-threshold blend
    uint256 constant TOX_BLEND_DECAY = 362846792996566191; // 0.78  [FIX 3] proper EMA (was 0.051)
    uint256 constant ACT_BLEND_DECAY = 985000000000000000; // 0.985
    uint256 constant PHAT_ALPHA = 212566619036652182; // 0.26
    uint256 constant PHAT_ALPHA_RETAIL = 54382065676217811; // 0.05
    uint256 constant DIR_IMPACT_MULT = 2;

    // --- [FIX 6] Gap-aware pHat update ---
    uint256 constant GAP_PHAT_ALPHA_BOOST = 26707574872856065; // 0.03 per elapsed step beyond 1
    ...
    // --- Adaptive Shock Gate ---
    uint256 constant GATE_SIGMA_MULT = 7732775887381152137;
    uint256 constant MIN_GATE = 30621741532974548; // 0.03 WAD

    // --- Cubic Toxicity ---
    uint256 constant TOX_CUBIC_COEF = 802533994385810997;

    // --- Trade-Tox Boost ---
    uint256 constant TRADE_TOX_BOOST = 271298237850724053;
    ...
    uint256 constant ARB_RET_MIN = 2983211874518010; // 33 bps vs pHat

    uint256 constant SHIELD_TRIGGER = 3362314417376352; // ~30 bps
    uint256 constant SHIELD_BUFFER = 304885359301266; // 10 bps
    ...
    // --- fee model constants ---
    uint256 constant BASE_FEE = 495993539670787;
    uint256 constant SIGMA_COEF = 111034113997309465; // 0.111
    uint256 constant LAMBDA_COEF = 1223706197482936;
    uint256 constant FLOW_SIZE_COEF = 380505367869944086;
    uint256 constant TOX_COEF = 19562460209282377;
    uint256 constant TOX_QUAD_COEF = 3216749463996964367;
    ...
    uint256 constant STALE_DIR_COEF = 663777977152785178; // [FIX 7] in mutable list
    uint256 constant SIGMA_TOX_COEF = 41085997704221765;
    uint256 constant TAIL_KNEE = 15200000000000000;
    uint256 constant TAIL_SLOPE_PROTECT = 839985527665159813; // 0.93
    ...
    function getName() external pure override returns (string memory) {
        return "Theov3LocalBest_D21_TOX_BLEND_DECAY_DN18_SIZE_BLEND_DECAY_UP8_PHAT_ALPHA_RETAIL_DN8_7DA01BC0";
    }
}

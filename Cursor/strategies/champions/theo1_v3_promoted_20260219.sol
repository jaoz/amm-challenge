...
contract Strategy is AMMStrategyBase {
    ...
    uint256 constant TOX_BLEND_DECAY = 638979079364568698; // 0.78  [FIX 3] proper EMA (was 0.051)
    uint256 constant ACT_BLEND_DECAY = 985000000000000000; // 0.985
    uint256 constant PHAT_ALPHA = 225910708870718841; // 0.26
    uint256 constant PHAT_ALPHA_RETAIL = 59027486435928255; // 0.05
    uint256 constant DIR_IMPACT_MULT = 2;

    // --- [FIX 6] Gap-aware pHat update ---
    uint256 constant GAP_PHAT_ALPHA_BOOST = 29613775393634143; // 0.03 per elapsed step beyond 1
    ...
    uint256 constant MIN_GATE = 30022700811221640; // 0.03 WAD

    // --- Cubic Toxicity ---
    uint256 constant TOX_CUBIC_COEF = 830349491892811213;

    // --- Trade-Tox Boost ---
    uint256 constant TRADE_TOX_BOOST = 290100269315291281;

    // --- Asymmetric Stale Dir [FIX 7: added to mutable list] ---
    uint256 constant STALE_ATTRACT_FRAC = 1090805571566645483; // 1.124
    ...
    uint256 constant SHIELD_TRIGGER = 3323830128248357; // ~30 bps
    uint256 constant SHIELD_BUFFER = 311207275356952; // 10 bps
    ...
    // --- fee model constants ---
    uint256 constant BASE_FEE = 482053217221031;
    uint256 constant SIGMA_COEF = 111034113997309465; // 0.111
    uint256 constant LAMBDA_COEF = 1249426789146159;
    uint256 constant FLOW_SIZE_COEF = 402210817848412601;
    uint256 constant TOX_COEF = 20637400720778704;
    uint256 constant TOX_QUAD_COEF = 3170344468358891062;
    uint256 constant ACT_COEF = 10851200000000000000;
    uint256 constant DIR_COEF = 1973333925646282;
    uint256 constant DIR_TOX_COEF = 13375974728655389;
    uint256 constant STALE_DIR_COEF = 705342778679946207; // [FIX 7] in mutable list
    ...
    function getName() external pure override returns (string memory) {
        return "Theo1LocalBest_D15_TOX_BLEND_DECAY_DN14_LAMBDA_COEF_DN7_PHAT_ALPHA_DN6_31445A97";
    }
}

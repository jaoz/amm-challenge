...
contract Strategy is AMMStrategyBase {
    ...
    uint256 constant TOX_BLEND_DECAY = 50412388429629288; // 0.051
    ...
    uint256 constant ARB_TR_MIN = 4291845493562231; // 40 bps of reserveY
    ...
    uint256 constant SIGMA_COEF = 111034113997309465; // 0.20
    ...
    uint256 constant STALE_DIR_COEF = 694900000000000000;
    ...
    function getName() external pure override returns (string memory) {
        return "Theo1LocalBest_D23_MIN_GATE_DN7_GATE_SIGMA_MULT_DN4_SIGMA_COEF_DN4_BBEF7E18";
    }
}

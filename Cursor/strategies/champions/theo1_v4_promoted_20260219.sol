...
contract Strategy is AMMStrategyBase {
    ...
    uint256 constant SIZE_BLEND_DECAY = 824744045132386708; // 0.818
    uint256 constant SIZE_SMALL_DECAY = 979850712983896004; // 0.98  [FIX 2] sub-threshold blend
    uint256 constant TOX_BLEND_DECAY = 445173755900715877; // 0.78  [FIX 3] proper EMA (was 0.051)
    uint256 constant ACT_BLEND_DECAY = 985000000000000000; // 0.985
    uint256 constant PHAT_ALPHA = 212566619036652182; // 0.26
    uint256 constant PHAT_ALPHA_RETAIL = 59027486435928255; // 0.05
    uint256 constant DIR_IMPACT_MULT = 2;

    // --- [FIX 6] Gap-aware pHat update ---
    uint256 constant GAP_PHAT_ALPHA_BOOST = 27932728563068515; // 0.03 per elapsed step beyond 1
    ...
    // --- Cubic Toxicity ---
    uint256 constant TOX_CUBIC_COEF = 830349491892811213;

    // --- Trade-Tox Boost ---
    uint256 constant TRADE_TOX_BOOST = 285233132521277418;

    // --- Asymmetric Stale Dir [FIX 7: added to mutable list] ---
    uint256 constant STALE_ATTRACT_FRAC = 1100904656913984419; // 1.124
    ...
    uint256 constant ARB_RET_MIN = 3217796639730805; // 33 bps vs pHat

    uint256 constant SHIELD_TRIGGER = 3373694202822686; // ~30 bps
    uint256 constant SHIELD_BUFFER = 305269802860340; // 10 bps
    ...
    // --- fee model constants ---
    uint256 constant BASE_FEE = 462094786428071;
    uint256 constant SIGMA_COEF = 111034113997309465; // 0.111
    uint256 constant LAMBDA_COEF = 1223706197482936;
    uint256 constant FLOW_SIZE_COEF = 398656123329339902;
    uint256 constant TOX_COEF = 19618770576364256;
    uint256 constant TOX_QUAD_COEF = 3055020761107702402;
    ...
    uint256 constant STALE_DIR_COEF = 692581502296263260; // [FIX 7] in mutable list
    uint256 constant SIGMA_TOX_COEF = 39941753132294908;
    uint256 constant TAIL_KNEE = 15200000000000000;
    uint256 constant TAIL_SLOPE_PROTECT = 837865775264596191; // 0.93
    uint256 constant TAIL_SLOPE_ATTRACT = 839985527665159813; // 0.955
    ...
    function getName() external pure override returns (string memory) {
        return "Theo1LocalBest_D22_TOX_BLEND_DECAY_DN30_PHAT_ALPHA_DN6_GAP_PHAT_ALPHA_BOOST_DN6_43A8AA59";
    }
}
